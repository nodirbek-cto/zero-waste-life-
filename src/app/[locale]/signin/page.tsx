...
import { signInAction, type SignInState } from '@/app/[locale]/(auth)/actions';
      ...
      >
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <p className="mt-6 text-center text-gray-600">
            {t('noAccount')}{' '}
            <Link href={`/${locale}/signup`} className="text-eco-600 font-medium hover:underline">
              {t('signUpLink')}
            </Link>
          </p>
        </div>
